package com.dataMall.excelCenter.controller;
...
import com.dataMall.excelCenter.feign.UserService;
import com.dataMall.excelCenter.service.ExcelAppService;
import com.dataMall.excelCenter.service.ExcelColDropdownService;
import com.dataMall.excelCenter.service.ExcelHeaderService;
import com.dataMall.excelCenter.utils.ExcelExportUtils;
import com.dataMall.excelCenter.utils.ExcelToJsonConverter;
import com.dataMall.excelCenter.vo.ExcelQueryConditionVo;
...
public class ExcelAppController {
    ...
    public BaseResponse<String> upload(@RequestPart MultipartFile file, @RequestHeader("token") String token) {
        ...
        if (flag) {
            throw new BusinessException(ErrorCode.FAIL, "表头存入数据库失败");
        }
    ...
    public BaseResponse<List<ExcelHeader>> getHeader(@PathVariable String appId) {
    ...
    public BaseResponse<List<ExcelHeader>> getHeaderWithDropdown(@PathVariable String appId) {
    ...
    public BaseResponse<Object> updateHeader(@RequestBody List<ExcelHeader> excelHeaders, @PathVariable String appId) {
        //不允许修改headerName
    ...
    public BaseResponse<Map<String, Object>> listData(@PathVariable String appId, @RequestParam int pageNum, @RequestParam int pageSize, @RequestBody List<ExcelQueryConditionVo> excelQueryConditionVoList) {
    ...
    public BaseResponse<Object> addData(@PathVariable String appId, @RequestBody Map<String, String> map) {
        //将map转为json
    ...
    public BaseResponse<Object> deleteData(@PathVariable String appId, @RequestBody List<String> idList) {
    ...
    public BaseResponse<Object> updateData(@PathVariable String appId, @RequestBody Map<String, Object> map) {
        //修改
    ...
    public BaseResponse<List<ExcelApp>> listExcelApp() {
    ...
    public BaseResponse<Map<String, String>> exportData(HttpServletResponse response, HttpServletRequest request, @PathVariable String appId, @RequestBody List<ExcelQueryConditionVo> excelQueryConditionVoList) {
    ...
    public BaseResponse<Object> deleteExcelApp(@PathVariable String appId) {
    ...
    public BaseResponse<Object> updateExcelApp(@RequestBody ExcelApp excelApp) {
    ...
    public ExcelApp getExcelApp(@RequestParam("appId") String appId) {
        return excelAppService.getOneByOption("app_id", appId);
    }
}
